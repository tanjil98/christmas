...
const firstMessage = "From all of us at Astra Virtu, we wish you a journey of endless curiosity and discovery! 🌟";
const secondMessage = "Let Chemistry spark the magic of creation in every corner of your life.";
...
typeText(message1Element, firstMessage, () => {
  
  typeText(message2Element, secondMessage);
});
